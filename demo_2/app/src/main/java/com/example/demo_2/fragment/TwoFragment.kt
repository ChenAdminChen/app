...
import com.example.demo_2.databinding.FragmentTwoBinding
...
class TwoFragment : androidx.fragment.app.Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        binding.buttonTwoA.setOnClickListener { listener!!.actionTwoToThree() }

        binding.buttonTwoB.setOnClickListener { listener!!.actionTwoToOne() }
