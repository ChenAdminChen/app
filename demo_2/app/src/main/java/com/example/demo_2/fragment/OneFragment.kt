...
import com.example.demo_2.databinding.FragmentOneBinding
...
class OneFragment : androidx.fragment.app.Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        var button = binding.buttonOne

        binding.buttonOne.setOnClickListener {
            listener!!.actionOneToTwo()
        }
