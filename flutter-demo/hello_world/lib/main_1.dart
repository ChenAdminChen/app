    ...
    return  new Scaffold(
      body:  new Column(
        ...
        children: <Widget>[
           ...
           new Container(
            padding: new  EdgeInsets.only(bottom: 15.0, left: 5.0),
            child: new  Row(
              children: <Widget>[

                new  Image.asset('assets/flutter-mark-square-64.png', scale: 1.5),
                new Text('Flutter test: ', style: const TextStyle(fontSize: 30.0)),
                new Text('${(v+(v1)).x}, ${(v-(v1)).x}', style: const TextStyle(fontSize: 30.0)),
              ],
            ),
